...
{
    public partial class FormSelectViewVehicleInformation : Form
    {
        ...
        public FormSelectViewVehicleInformation()
        {
            InitializeComponent();
        }

        private void FormSelectViewVehicleInformation_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    this.Hide();
                   FormViewVehicleInformation EditodrFrom = new FormViewVehicleInformation(r1, r2);
                    EditodrFrom.Show();
                }
            }
        ...
        private void FormSelectViewVehicleInformation_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
