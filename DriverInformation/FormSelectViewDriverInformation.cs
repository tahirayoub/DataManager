...
{
    public partial class FormSelectViewDriverInformation : Form
    {
        ...
        public FormSelectViewDriverInformation()
        {
            InitializeComponent();
        }
        ...
        private void FormSelectViewDriverInformation_Load(object sender, EventArgs e)
        {
            try
            {
                this.TopMost = true;
        ...
        private void dataGridView1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    this.Hide();
                    FormViewDriverInformation EditodrFrom = new FormViewDriverInformation(r2);
                    EditodrFrom.Show();
                }
            }
